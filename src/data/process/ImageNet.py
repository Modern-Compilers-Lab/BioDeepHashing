...
new_path_database = "data/raw/ImageNet/ILSVRC/Data/CLS-LOC/train"
new_path_val = "data/raw/ImageNet/ILSVRC/Data/CLS-LOC/val"
...
with open(input_dir / "train.txt","r") as input_file, open(output_dir / "train_metadata.txt","w") as train_file:
    ...
    for line in lines:
        ...
        labels = " ".join(splited_line[1:])
        new_path = f"data/raw/ImageNet/ILSVRC/Data/CLS-LOC/train/{file_prefix}"
