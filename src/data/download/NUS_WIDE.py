...
download(IMAGE_LIST_URL, OUTPUT_DIR / "ImageList.zip")
unzip(OUTPUT_DIR / "ImageList.zip", OUTPUT_DIR)
...
subprocess.run(["/tmp/rar/unrar", "e", str(OUTPUT_DIR / "NUS-WIDE-urls.rar"), str(OUTPUT_DIR)])
